...
const useValidate = (): ((value: string | File, type: string, fileType: string) => ValidationResult) => {
  return (value: string | object, type: string, fileType: string): ValidationResult => {
