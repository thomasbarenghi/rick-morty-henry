...
export const isValidName = (value: string): validResponse => {
  ...
  if (!isValid) {
    return {
      isValid: false,
      error: 'El nombre no puede contener caracteres especiales y debe tener entre 1 y 40 caracteres'
    }
  } else {
    return {
      isValid: true,
...
export const isValidLastName = (value: string): validResponse => {
  ...
  if (!isValid) {
    return {
      isValid: false,
      error: 'El apellido no puede contener números ni caracteres especiales y debe tener entre 1 y 40 caracteres'
    }
  } else {
    return {
      isValid: true,
...
export const isValidUsername = (value: string): validResponse => {
  ...
  if (!isValid) {
    return {
      isValid: false,
      error: 'El nombre de usuario no puede contener caracteres especiales y debe tener entre 1 y 40 caracteres'
    }
  } else {
    return {
      isValid: true,
...
export const isValidPassword = (value: string): validResponse => {
  ...
  if (!isValid) {
    return {
      isValid: false,
      error: 'La contraseña debe tener al menos 8 caracteres, una letra mayúscula, un número y un caracter especial'
    }
  } else {
    return {
      isValid: true,
