...
import { technologies } from './technologies.lib'
...
const ProjectDescription = () => (
  <section id={styles['seccion-descripcion-proyecto']} className='padding-t1'>
    ...
    <p className='margin-b-0 body-regular'>
      ¡Hola! Te cuento sobre mi aplicación de Rick y Morty. Es una plataforma en línea donde puedes explorar el universo
      de la popular serie animada. A través de mi aplicación, puedes descubrir personajes, ver sus imágenes y obtener
      información detallada sobre ellos. Además, puedes buscar episodios, ubicaciones y más en la base de datos de la
      serie. Con mi aplicación, tendrás todo lo que necesitas para explorar el universo de Rick y Morty de una manera
      sencilla y emocionante. ¡Espero que disfrutes explorando todo lo que tengo que ofrecer!
      <br />
    </p>
  </section>
)
        ...
        <div key={tecnologia.id} className='d-flex flex-column' style={{ gap: 8 }}>
          <div className='d-flex justify-content-start align-items-center' style={{ gap: 14 }}>
            <Image
              ...
              height={50}
            />
            <h1 className='margin-b-0 titulo3-bold'>{tecnologia.title} </h1>
          </div>
